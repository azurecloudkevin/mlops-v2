...
git_folder_location='/home/kev/Runs'   #replace with the local root folder location where you want to create the project folder
project_name=mlops-v2  #replace with your project name
github_org_name=azurecloudkevin   #replace with your github org name
